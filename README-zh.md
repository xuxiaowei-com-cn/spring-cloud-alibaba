...
更多功能请参考 [Roadmap](https://github.com/alibaba/spring-cloud-alibaba/blob/2026.0.x/Roadmap-zh.md)
...
更多组件请参考 [Roadmap](https://github.com/alibaba/spring-cloud-alibaba/blob/2026.0.x/Roadmap-zh.md)。

## 如何构建
* 2026.0.x 分支对应的是 Spring Cloud 2026.0.x 与 Spring Boot 4.2.x，最低支持 JDK 17。
...
[Sentinel Example](https://github.com/alibaba/spring-cloud-alibaba/tree/2026.0.x/spring-cloud-alibaba-examples/sentinel-example/sentinel-core-example/readme-zh.md)

[Nacos Example](https://github.com/alibaba/spring-cloud-alibaba/blob/2026.0.x/spring-cloud-alibaba-examples/nacos-example/readme-zh.md)

[RocketMQ Example](https://github.com/alibaba/spring-cloud-alibaba/blob/2026.0.x/spring-cloud-alibaba-examples/rocketmq-example/readme-zh.md)

[Seata Example](https://github.com/alibaba/spring-cloud-alibaba/blob/2026.0.x/spring-cloud-alibaba-examples/seata-example/readme-zh.md)
...
* 2026.0.x 版本适用于 Spring Boot 4.2.x
